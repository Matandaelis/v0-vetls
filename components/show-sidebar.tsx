    ...
    <div className="flex flex-col h-full bg-gray-950 border-l border-border">
            ...
            <div key={comment.id} className="text-sm space-y-2">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <button className="mt-1 text-xs text-muted-foreground hover:text-primary flex items-center gap-1" aria-label={`Like comment${comment.likes > 0 ? `, ${comment.likes} likes` : ''}`}>
      ...
      <div className="p-3 border-t border-border">
        <div className="flex gap-2">
          ...
          />
          <Button size="icon" className="h-9 w-9" onClick={handleSendMessage} disabled={!messageText.trim()} aria-label="Send message">
