          ...
          <Card key={product.id} className="p-4 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex gap-2">
                <Button size="icon" variant="ghost" aria-label={"View analytics for " + product.name} title={"View analytics for " + product.name}>
                  <BarChart className="w-4 h-4" aria-hidden="true" />
                </Button>
                <Button size="icon" variant="ghost" aria-label={"Edit " + product.name} title={"Edit " + product.name}>
                  <Edit className="w-4 h-4" aria-hidden="true" />
                </Button>
                <Button size="icon" variant="ghost" className="text-destructive" aria-label={"Delete " + product.name} title={"Delete " + product.name}>
