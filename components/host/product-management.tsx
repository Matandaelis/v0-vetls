          ...
          <Card key={product.id} className="p-4 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex gap-2">
                <Button aria-label={`View stats for ${product.name}`} size="icon" variant="ghost">
                  <BarChart className="w-4 h-4" />
                </Button>
                <Button aria-label={`Edit ${product.name}`} size="icon" variant="ghost">
                  <Edit className="w-4 h-4" />
                </Button>
                <Button aria-label={`Delete ${product.name}`} size="icon" variant="ghost" className="text-destructive">
