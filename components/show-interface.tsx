      ...
      <div className="flex-1 flex flex-col gap-4">
        ...
        <div className="px-4 md:px-0 space-y-4">
          <div className="flex items-start justify-between gap-4">
            ...
            <Button variant="outline" size="sm" className="rounded-full gap-1.5 h-8 text-xs font-semibold shadow-sm">
          ...
          {activeTab === 'shop' && (
            <div className="p-4 space-y-4">
              {featuredProducts.map((product) => (
                <div key={product.id} className="flex gap-4 p-3 rounded-xl border border-gray-100 bg-white shadow-sm hover:shadow-md transition-shadow">
                  {/* Product Image */}
              ...
              <div className="fixed bottom-4 left-4 z-50 md:absolute md:bottom-4 md:left-4">
                <Button size="icon" className="rounded-full bg-[#0057B8] hover:bg-[#004494] text-white shadow-lg h-10 w-10">
