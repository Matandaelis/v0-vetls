              ...
              {poll.options.map((option) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-2 rounded-lg transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ${
          ...
          <div className="grid grid-cols-4 gap-2">
            {["❤️", "😍", "🔥", "👏", "😂", "🎉", "💯", "🙌"].map((emoji) => (
              <Button
                ...
                className="text-xl h-10 hover:scale-110 transition-transform focus-visible:ring-2 focus-visible:ring-offset-2"
              >
                {emoji}
              </Button>
            ))}
