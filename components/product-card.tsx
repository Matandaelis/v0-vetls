    ...
    <Card className="relative group overflow-hidden hover:shadow-lg transition-shadow h-full flex flex-col">
      ...
      <div className="p-4 flex flex-col flex-1">
        <div className="flex items-start justify-between gap-2 mb-2">
          <div className="flex-1">
            <h3 className="font-semibold line-clamp-2">
              <Link href={`/products/${product.id}`} className="before:absolute before:inset-0 before:z-0">
                {product.name}
              </Link>
            </h3>
        ...
        <div className="mt-auto flex flex-col gap-3">
          ...
          <Button onClick={handleAddToCart} size="sm" className="w-full relative z-10" variant={isAdded ? "default" : "outline"}>
