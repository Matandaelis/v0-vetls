...
## 2025-03-05 - Star Rating Forms
**Learning:** The interactive star rating form was using generic <div>s, and visually mimicking standard inputs but ignoring keyboard, screen reader states and missing proper logical mappings between labels and text inputs.
**Action:** When building interactive rating inputs, use individual scalable SVG icons with native role="radiogroup" and role="radio" attributes, and explicitly mapped inputs using htmlFor/id attributes.
