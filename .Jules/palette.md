...
## 2025-03-05 - Form Submissions Accessibility
**Learning:** During form submission states, interactive components are often disabled to prevent duplicate submissions, but they lack semantic indicators of this processing state.
**Action:** Always add `aria-busy={isSubmitting}` to submit buttons when disabling them due to an ongoing async operation.
