...
## 2025-03-05 - Semantic Rating Inputs
**Learning:** Interactive star rating components implemented using generic wrapper elements inside forms can lack proper screen reader context and grouping, resulting in inaccessible redundant text.
